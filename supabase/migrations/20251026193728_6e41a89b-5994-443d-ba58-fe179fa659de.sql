-- Corrigir função get_dashboard_geral_data para usar 'Em Andamento' e comparações ::text
  ...
  SELECT json_build_object(
    ...
    'tarefas_resumo', (
      SELECT json_build_object(
        ...
        'atrasadas', COUNT(*) FILTER (WHERE prazo < CURRENT_DATE AND status::text != 'Concluído'),
        'taxa_conclusao', CASE 
