-- Ajustes na função: status válidos, coluna correta em requisicoes e visibilidade para encarregado
...
BEGIN
  ...
  -- Buscar nome do usuário (profiles)
  ...
  SELECT json_build_object(
    ...
    'kpis_gerais', (
      SELECT json_build_object(
        ...
        'projetos_ativos', COUNT(*) FILTER (WHERE status IN ('Em Andamento', 'Pausado')),
