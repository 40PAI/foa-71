        ...
        <Card key={index}>
          <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
            <div className="flex items-center gap-1 min-w-0 flex-1">
              <CardTitle
                className="font-medium break-words leading-tight min-w-0 flex-1"
          ...
          <CardContent>
            <div className="font-bold break-all leading-tight" style={{ fontSize: "clamp(1rem, 2.4vw, 1.5rem)" }}>{card.value}</div>
          </CardContent>
        </Card>
      ))}
    </div>
