  ...
  return (
    <Card className="overflow-hidden">
      <CardHeader className="py-2 px-3">
        <CardTitle className="text-lg font-semibold">Finanças</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3 px-3 pb-3 pt-0">
        <div className="grid grid-cols-2 gap-3">
          <div className="p-2 border rounded bg-muted/30">
            <p className="text-xs text-muted-foreground leading-tight">Orçamento Total</p>
            <p className="text-base font-bold break-all leading-tight">{formatCurrency(orcamentoTotal)}</p>
          </div>
          <div className="p-2 border rounded bg-muted/30">
            <p className="text-xs text-muted-foreground leading-tight">Gasto Total</p>
            <p className="text-base font-bold break-all leading-tight">{formatCurrency(gastoTotal)}</p>
        ...
        {topProjetosGasto.length > 0 ? (
          <div className="w-full">
            <h3 className="text-sm font-semibold mb-1.5">Top 5 Projetos</h3>
            <div className="w-full">
